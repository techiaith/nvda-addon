...
TECHIAITH_VOICES_BASE_DIR = os.path.join(globalVars.appArgs.configPath, "techiaith_tts")
TECHIAITH_VOICES_DIR = os.path.join(
    TECHIAITH_VOICES_BASE_DIR, "voices", "piper"
)
